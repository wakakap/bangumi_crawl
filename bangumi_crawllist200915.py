...
sum=0
ersum=0
an = float(input('请选择所爬取的列表: anime(1) or game(2) or book(3) or music(4) or real(5)\n'))
if an==2:
    choose='game'
elif an==3:
    choose = 'book'
...
URL = 'https://bangumi.tv/'+choose+'/list/wakakap/collect?page='+str(page)
...
#        'name':'chii_auth',
#        'value':'DnISpiGCNShLClf0%2BVB%2F3CT%2FZhWikU2harYJAH%2BM0NBxxMmTdSy92NJWhhao8ZqwaZ69FKsFpgu%2FtXfQTt9atc0sKffbFn0Wf78v',
#        'path':'/'}
...
csv_file = open('my'+choose+'animelist'+time_now+'.csv',"w",newline='',encoding="utf-8")#创建csv
